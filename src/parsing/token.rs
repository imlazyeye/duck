...
impl Token {
    pub fn to_literal(&self) -> Option<Literal> {
        match self {
            ...
            Token::PointerNull => Some(Literal::PointerNull),
            Token::PointerInvalid => Some(Literal::PointerInvalid),
            Token::Undefined => Some(Literal::Undefined),
            Token::NaN => Some(Literal::NaN),
            Token::Infinity => Some(Literal::Infinity),
            Token::Pi => Some(Literal::Pi),
